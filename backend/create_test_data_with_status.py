...
test_data = [
    {
        "order_id": f"TEST-PENDING-{random.randint(10000, 99999)}",
        "product_id": f"PROD-{random.randint(1000, 9999)}",
        "product_name": "高级无线耳机-待处理",
    ...
    {
        "order_id": f"TEST-PROCESSING-{random.randint(10000, 99999)}",
        "product_id": f"PROD-{random.randint(1000, 9999)}",
        "product_name": "智能手表-处理中",
        "product_category": "电子产品",
    ...
    {
        "order_id": f"TEST-COMPLETED-{random.randint(10000, 99999)}",
        "product_id": f"PROD-{random.randint(1000, 9999)}",
        "product_name": "羊毛衫-已完成",
        "product_category": "服装",
        "return_reason": "尺寸不合适",
